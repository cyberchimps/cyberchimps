	...
	<?php if ( have_comments() ) : ?>
		...
		<ol class="commentlist">
			<?php
				 ...
				 * to use response_comment() to format the comments.
				 * If you want to overload this in a child theme then you can
				 * define response_comment() and that will be used instead.
				 * See response_comment() in functions.php for more.
				 */
				wp_list_comments( array( 'callback' => 'response_comment' ) );
			?>
		</ol>
