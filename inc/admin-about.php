...
function cyberchimps_display_about() {
	...
	<div class="about-container">
		...
		<div class="about-info">
			<h1><?php echo "CyberChimps - ".$theme['Version'] ?></h1>
			<?php
				$directory_uri = get_template_directory_uri();

			?>
			<span><img src="<?php echo $directory_uri ?>/images/logo.png"></span>
			<?php printf( '<p>CyberChimps Free is designed for anyone looking to build their own website including first time WordPress users, graphic designers, and developers who want a 6-month head start on the competition. This easy to customize multipurpose WordPress Theme will help you create an amazing website.'
			); ?>
		</div>
		...
		<div class="buy">
		<a class="button button-primary buylink" target="_blank" href="https://cyberchimps.com/store/cyberchimpspro/?utm_source=about">Buy CyberChimps Pro</a>
		</div>
	</div>
<?php
}
